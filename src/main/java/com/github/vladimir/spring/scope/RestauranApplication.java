...
public class RestauranApplication {
    public static void main(String[] args) {
        ...
        ObjectProviderExemple objectProviderExemple=context.getBean(ObjectProviderExemple.class);
        
        objectProviderExemple.getAndCompareHeadChef();
        objectProviderExemple.getAndCompareWaiter();
    }
}
